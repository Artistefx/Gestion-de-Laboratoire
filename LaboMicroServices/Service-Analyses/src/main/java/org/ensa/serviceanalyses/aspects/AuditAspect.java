package org.ensa.serviceanalyses.aspects;
...
public class AuditAspect {
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceanalyses.controllers.*.create*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceanalyses.controllers.*.update*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceanalyses.controllers.*.delete*(..))", returning = "response")
