package org.ensa.serviceutilisateurs.aspects;
...
import org.ensa.serviceutilisateurs.repositories.AuditLogRepository;
...
public class AuditAspect {
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceutilisateurs.controllers.*.create*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceutilisateurs.controllers.*.update*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.serviceutilisateurs.controllers.*.delete*(..))", returning = "response")
