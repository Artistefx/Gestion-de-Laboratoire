package org.ensa.servicelaboratoire.aspects;
...
import org.ensa.servicelaboratoire.repositories.AuditLogRepository;
...
public class AuditAspect {
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.servicelaboratoire.controllers.*.create*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.servicelaboratoire.controllers.*.update*(..))", returning = "response")
    ...
    @AfterReturning(pointcut = "execution(* org.ensa.servicelaboratoire.controllers.*.delete*(..))", returning = "response")
